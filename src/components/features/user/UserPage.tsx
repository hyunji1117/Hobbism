      ...
      <main>
        ...
        <section>
          <Tabs defaultValue="feed">
            <TabsList className="h-14 w-full rounded-none border-b bg-white px-5">
              <TabsTrigger value="feed" className="!shadow-none">
                {isMypage ? '내 피드' : '피드'}
              </TabsTrigger>
              {isMypage && (
                <TabsTrigger value="shop" className="!shadow-none">
                  쇼핑 내역
                </TabsTrigger>
              )}
            </TabsList>
